...
def clean_extracted_url(raw_url: str, base_url: str) -> str:
    """
    Cleans unwanted characters from a raw URL and, if the URL is on the same domain
    as the base, removes the duplicate base path.
    """
...
async def main():
    ...
    urls_extracted = []
    all_cleaned_markdown = []  # Markdown from stage 2 and stage 3.
    ...
    async with AsyncWebCrawler(config=browser_conf) as crawler:
        ...
        for res in results:
            ...
            print("Markdown snippet:", cleaned_markdown[:300], "\n")
    ...
    # Now, all_cleaned_markdown holds the content to be embedded later.
