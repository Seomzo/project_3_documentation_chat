...
def create_conversation_chain(retriever, api_key, model_name="gpt-4o-mini"):
    ...
    Use only the following context to answer the user's question. If the information is not in the context, use your base knowldge and say "I don't see that in context, but [relevant information from base knowledge]. Would you like me to help with something else?"
